...
The date and time the file was sent toÂ OCR
...
Note: `null` value is returned when the file is not sent toÂ OCR
...
File was successfully processed byÂ OCR
...
```
{
  "attachment": "data:application/pdf;base64,JVBERi0xLjQKJY8KMiAwIG9â¦E1CiUlRU9GCg==",
  "send_to_ocr": true
}
```
...
```
{
  "attachment": "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgâ¦Cg==",
  "filename": "INV123654.png",
  "send_to_ocr": true
}
```
...
## [Send Inbox File toÂ OCR](#send-inbox-file-to-ocr)
...
### Response if file cannot be sent toÂ OCR
