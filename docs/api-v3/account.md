...
Days after the due date toÂ send aÂ automatic overdue reminder?
...
Send aÂ thank you email when invoices is paid automatically?
...
Number of remaining extractions byÂ Digitoo service
...
Account detail is read-only, please use the web interface toÂ make changes.
...
```
{
  ...
  "vat_rate": 21,
  "displayed_note": "",
  "invoice_note": "Fakturujeme VÃ¡m nÃ¡sledujÃ­cÃ­ poloÅ¾ky",
  "due": 14,
  "invoice_language": "cz",
