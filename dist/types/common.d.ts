...
export declare class FakturoidApiError extends Error {
    readonly status: number;
    readonly details?: FakturoidApiErrorDetails;
    constructor(status: number, message: string, details?: FakturoidApiErrorDetails);
}
 ...
 */
export declare function paginateAll<T>(fetchPage: (page: number) => Promise<T[]>): AsyncGenerator<T, void, undefined>;
...
export type FakturoidLanguage = 'cz' | 'sk' | 'en' | 'de' | 'fr' | 'it' | 'es' | 'ru' | 'pl' | 'hu' | 'ro';
 ...
 */
export type FakturoidVatRate = number | NumericString | 'standard' | 'reduced' | 'reduced2' | 'zero' | 'none';
/**
 ...
 */
export type FakturoidVatPriceMode = 'with_vat' | 'without_vat' | 'numerical_with_vat' | 'from_total_with_vat';
 ...
 */
export type InvoiceDocumentType = 'invoice' | 'proforma' | 'partial_proforma' | 'correction' | 'tax_document' | 'final_invoice';
/**
